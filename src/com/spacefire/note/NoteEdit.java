...
public class NoteEdit extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRowId = (savedInstanceState == null) ? null :
            (Long) savedInstanceState.getSerializable(SFDB.KEY_ROWID);
        if (mRowId == null) {
            Bundle extras = getIntent().getExtras();
            mRowId = extras != null ? extras.getLong(SFDB.KEY_ROWID)
                                    : null;
        }
	  ...
	  @Override
	    protected void onSaveInstanceState(Bundle outState) {
	        ...
	        saveState();
	        outState.putSerializable(SFDB.KEY_ROWID, mRowId);
	    }
	    ...
	    private void populateFields() {
	        if (mRowId != null) {
	            ...
	            mTitleText.setText(note.getString(
	    	            note.getColumnIndexOrThrow(SFDB.KEY_TITLE)));
	            mBodyText.setText(note.getString(
	                    note.getColumnIndexOrThrow(SFDB.KEY_BODY)));
